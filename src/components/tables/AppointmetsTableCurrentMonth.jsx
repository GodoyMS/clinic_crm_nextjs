...
const   AppointmetsTableCurrentMonth = () => {
  ...
  return (
    <div className="sm:px-6 w-full">
      ...
      <div className="bg-white py-1  md:py-4 px-4 md:px-8 xl:px-10 max-h-[80vh] overflow-y-scroll">
        ...
        <div className="mt-1 overflow-x-auto pb-40 ">
...
export default AppointmetsTableCurrentMonth;
