...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(
        `${backendURL}/api/v1/clinic/signin`,
        { email, password },
      ...
      .then(
        async () =>
          await axios.get(`${backendURL}/api/v1/clinic/currentUser`, {
            withCredentials: "include",
          })
      )
      .then(({ data }) => dispatch(setClinicInfo(data.user)))
      .then(() =>
        axios.get(`${backendURL}/api/v1/clinic/getClinicPatients`, {
          withCredentials: "include",
        })
      )
      .then(({ data }) => dispatch(setAllPatients(data.patients)))
      .then(() =>
        axios.get(`${backendURL}/api/v1/clinic/doctor/getClinicDoctors`, {
          withCredentials: "include",
        })
      )
          ...
          <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            ...
            <div className="py-10">
              ...
              <div className="  flex flex-col ">
                <span>Usuario: demo123@gmail.com</span>
            ...
            <div className="mt-12">
              <form onSubmit={handleSubmit}>
                <div>
                  ...
                  <input
                    className="w-full text-lg p-2 rounded-md border-b form-input border-gray-300 placeholder:text-sm focus:outline-none focus:border-indigo-500"
                    type="email"
                    value={email}
                ...
                <div className="mt-8">
                  ...
                  <input
                    className="w-full text-lg p-2 border-b rounded-md form-input placeholder:text-sm  border-gray-300 focus:outline-none focus:border-blue-500"
                    type="password"
                    value={password}
