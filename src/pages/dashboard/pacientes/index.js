            ...
            patients.map((e) => (
              <Table.Row key={e._id} className="bg-white">
                <Table.Cell className="whitespace-nowrap font-medium flex gap-2 justify-start  items-center">
                  <Image width={100} height={100} alt="Paciente" className="w-6 h-6" src={e.sex === "Hombre" ? "/assets/icons/patientMan.png":"/assets/icons/patientWoman.png"}/>
                  <Link className="text-blue-500 hover:text-blue-700"  href={`/dashboard/pacientes/${e._id}`}>
                  {e.names}
