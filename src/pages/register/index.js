...
import { useClinicRegister } from "@/hooks/useClinicRegister";
export default function RegisterComponent() {
  ...
  const { infoClinic } = useSelector((state) => state.clinic);
  ...
  return (
    ...
    <div className="min-w-screen min-h-screen  flex items-center justify-center px-5 py-5">
      <form
        ...
        className="bg-white text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden max-w-5xl"
      >
        {isModalRegisterActive && (
          <div
            style={{ zIndex: 500 }}
            className="fixed  flex items-center top-0 left-0 right-0 z-50 bg-black bg-opacity-50  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-screen max-h-full"
          >
            <div className="relative w-full max-w-2xl mx-auto max-h-full ">
              <div className="relative bg-white rounded-lg shadow ">
                <div className="flex items-start justify-between p-4 border-b rounded-t ">
                  <button
                    onClick={() => setIsModalRegisterActive(false)}
            ...
            <div>
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  ...
                  <div className="flex">
                    <div className="input-form w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                    ...
                    <input
                      ...
                      type="text"
                      {...register("username")}
                      className="w-full  bg-gray-50 -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                      placeholder="John"
                    />
                  </div>
                </div>
                ...
                <div className="w-full px-3 mb-5">
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      type="email"
                      {...register("email")}
                      className="form-input  bg-gray-50  w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                ...
                <div className="w-full px-3 mb-4">
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      {...register("password")}
                      required
                      className="w-full form-input -ml-10 pl-10 pr-3 bg-gray-50  py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                      placeholder="************"
                    />
                  </div>
                </div>
                ...
                <div className="w-full px-3 mb-12">
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      {...register("confirmPassword")}
                      required
                      className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 bg-gray-50  border-gray-200 outline-none focus:border-indigo-500 form-input"
                      placeholder="************"
                    />
                  </div>
                </div>
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  <button
                    type="submit"
                    className="block w-full button max-w-xs mx-auto bg-blue-500 hover:bg-blue-700 focus:bg-blue-700 text-white rounded-lg px-3 py-3 font-semibold"
                  >
                    Registrarse
                  </button>
                </div>
