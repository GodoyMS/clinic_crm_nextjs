...
const LayoutMain = ({ children }) => {
  ...
  return (
    <>
      <nav style={{zIndex:900}} className="  px-4 py-4 w-full relative bg-gray-100">
      ...
      {isChatActive && (
        <div
          style={{ zIndex: 300 }}
          className="fixed bottom-5 right-5 w-72 divide-y rounded-md border shadow-md bg-white"
        >
      ...
      {!isChatActive && (
        <div
          ...
          style={{ zIndex: 300 }}
          className="fixed bottom-5 cursor-pointer bg-gray-100 rounded-full p-2 right-5 "
        >
