...
const Consent = ({ data }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await axios
        ...
        .put(
          `${backendURL}/api/v1/clinic/uploadConsent/${data._id}`,
          formData,
          {
  ...
  const handleDeleteConsent=async(e)=>{
    await axios.put(
      `${backendURL}/api/v1/clinic/deleteConsent/${data._id}`,
      {consentUrl:e},
      {
        withCredentials: "include",
      }
  ...
  return (
    ...
    {isToastActive && (
        ...
        <Toast
          message={"Consentimiento borrado exitosamente"}
...
<div className="py-8 px-2 grid gap-4 grid-cols-1 md:grid-cols-2">
      ...
      <div className=" mx-auto">
        ...
        >
          ...
          Los consentimientos que subas mediante nuestro sistema se mantendra actualizado y puede ser
      ...
      <div className="relative pt-4  overflow-x-auto shadow-md  sm:rounded-lg">
        <h2 className="p-2 text-center text-gray-600 ">
          Repositorio de consentimientos
        </h2>
        <table className="w-full  text-sm text-left text-gray-500 ">
          ...
          <tbody>
            {data.consent.map((e,index)=>(
               ...
               <th scope="col" className="px-6 py-3">
                <button onClick={() => handleDeleteConsent(e)} className="bg-gray-200 text-gray-700 rounded-md p-2 hover:bg-gray-300" >Eliminar</button>
               </th>
             </tr>
